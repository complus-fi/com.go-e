...
- The `goe_transaction_name_changed` and `goe_meter_power_name_changed` triggers expose the derived card name when the corresponding read-only name capabilities change.
