...
| goe_flexible_rate           | Read         | awcp                 | Reads `awcp.marketprice` (cents) and converts to euros                                                         | Rounded to 3 decimals                                                                                |
| goe_flexible_rate_limit     | Read + write | awp                  | Reads/writes max flexible price by converting between API cents and capability euros                           | Write converts euros to cents                                                                        |
